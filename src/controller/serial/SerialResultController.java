...
public class SerialResultController implements Initializable {
    @FXML
    ...
    private void updateVisibility() {
        switch (count){
            case 1:
                for (int j = 0; j < lineEndControl.getChildren().size(); j++) {
                    if (lineEndControl.getChildren().get(j).getId().equals("setOnCount1")) {
                        lineEndControl.getChildren().get(j).setVisible(true);
                        break;
                    }
                }
                break;
            case 2:
                for (int j = 0; j < lineEndControl.getChildren().size(); j++) {
                    if (lineEndControl.getChildren().get(j).getId().equals("setOnCount2")) {
                        lineEndControl.getChildren().get(j).setVisible(true);
                        break;
                    }
                }
            ...
            case 3:
                for (int j = 0; j < lineEndControl.getChildren().size(); j++) {
                    if (lineEndControl.getChildren().get(j).getId().equals("setOnCount3")) {
                        lineEndControl.getChildren().get(j).setVisible(true);
                        break;
                    }
                }
            ...
            case 4:
                for (int j = 0; j < lineEndControl.getChildren().size(); j++) {
                    if (lineEndControl.getChildren().get(j).getId().equals("setOnCount4")) {
                        lineEndControl.getChildren().get(j).setVisible(true);
                        break;
                    }
                }
            ...
            case 5:
                for (int j = 0; j < lineEndControl.getChildren().size(); j++) {
                    if (lineEndControl.getChildren().get(j).getId().equals("setOnCount5")) {
                        lineEndControl.getChildren().get(j).setVisible(true);
                        break;
                    }
                }
